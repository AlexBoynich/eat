        ...
        <div class="startBlock container">
            ...
            <div class="buttonsBlock">
                ...
                <div class="rightBlock">
                    ...
                    <button class="conditions"
                    @click="replace('https://drive.google.com/file/d/1_L0A5zC-xd-7_o6VsZf2KBgpKP2PbN2b/view?usp=drive_link')"><a>Условия  <img src="/angle.png" alt="" class="angle"></a></button>
                </div>
            </div>
        </div>
